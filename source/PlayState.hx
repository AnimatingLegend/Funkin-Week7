	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
				...
				case 'ugh' | 'guns':
				{
					...
					smokeLeft.animation.addByPrefix('idle', 'SmokeBlurLeft ', 24);
					...
					smokeRight.animation.addByPrefix('idle', 'SmokeRight ', 24);
					...
					tower.animation.addByPrefix('idle', 'watchtower gradient color instance', 24);
					tower.antialiasing = true;
					add(tower);
	
					var tankRolling = new FlxSprite(300,300);
					tankRolling.frames = Paths.getSparrowAtlas('warzone/tankRolling');
					tankRolling.animation.addByPrefix('idle', 'BG tank w lighting instace', 24);
					...
					tankBop1.animation.addByPrefix('bop', 'fg tankhead far right instance', 24);
					...
					tankBop2.animation.addByPrefix('bop','fg tankhead 5 instance', 24);
					...
					tankBop3.animation.addByPrefix('bop','foreground man 3 instance', 24);
					...
					tankBop4.animation.addByPrefix('bop','fg tankhead 4 instace', 24);
					...
					tankBop5.animation.addByPrefix('bop','fg tankman bobbin 3 instance', 24);
					...
					tankBop6.animation.addByPrefix('bop','fg tankhead far right instance', 24);
